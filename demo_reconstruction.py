...
csm, axf = compute_csm(rf_filtered, probe, K=130, overlap=0.9, f=[4.5e6, 5.5e6])
...
# %%
img_das = das.solve(csm, freqs, average=False)
...
plt.subplot(1, 3, 1) 
plot_result_dB(img_das[1,:,:], grid, "DAS - Point Source", dynamic_range=20)
